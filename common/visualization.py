...
def render_animation(keypoints, keypoints_metadata, poses, skeleton, fps, bitrate, azim, output, viewport,
    ...
    """
    #print(test_generator.num_frames())
    print("keypoints")
    ...
    f = open('/home/developer/Downloads/FußDaten.txt', 'w')
    sys.stdout = f
    #for i in range(0,17):
    for i in range(0,var):

        # gibt alle frames(i fotos) der Video mit keypoints 15 und
        # 16 enstprechend der linke und rechte Fuss
       print("",keypoints[i][15])
       print("", keypoints[i][16])
       #print("",keypoints[0][16])
    ...
    import sys
    orig_stdout = sys.stdout
    f = open('/home/developer/Downloads/armeDaten.txt', 'w')
    sys.stdout = f
    for i in range(0,var):

        print("", keypoints[i][8])
        print("", keypoints[i][10])
        #print("", keypoints[i][16])
    # print("",keypoints[0][16])
