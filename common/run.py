...
var=test_generator.num_frames()
print('INFO: Testing on {} frames',var)
...
# Evaluate
def evaluate(test_generator, action=None, return_predictions=True):
    epoch_loss_3d_pos = 0
...
if args.render:
    ...
    if args.viz_output is not None:
        ...
        anim_output = {'Reconstruction1': prediction}
